...
INSERT INTO "events" VALUES(1,'Tech Conference 2025','A conference about the latest in software and AI.','Full-day tech event with talks and networking.',1741597200,'Tech Hub, Oslo',199,2,'Technology','https://example.com/images/tech-conf.jpg',1763377533,NULL,NULL,'upcoming');
INSERT INTO "events" VALUES(2,'Art Expo Spring','Exhibition of modern Scandinavian art.','Explore new works from emerging artists.',1743850800,'Art Gallery, Bergen',120,3,'Art','https://example.com/images/art-expo.jpg',1763377533,NULL,NULL,'upcoming');
INSERT INTO "events" VALUES(3,'Summer Music Festival','Outdoor music festival with multiple stages.','Live bands, DJs and food trucks all weekend.',1750428000,'City Park, Trondheim',850,4,'Music','https://example.com/images/music-festival.jpg',1763377533,NULL,NULL,'upcoming');
INSERT INTO "events" VALUES(4,'Startup Pitch Night','Local startups pitch to investors and the community.','Short pitches, Q&A and mingling.',1739640600,'Innovation House, Oslo',0,2,'Business','https://example.com/images/pitch-night.jpg',1763377533,NULL,NULL,'ended');
INSERT INTO "events" VALUES(5,'Street Food Festival','Tasting from food trucks and local restaurants.','Family-friendly food festival with live music.',1746878400,'Harbour Area, Stavanger',50,5,'Food & Drink','https://example.com/images/food-festival.jpg',1763377533,NULL,NULL,'upcoming');
INSERT INTO "events" VALUES(6,'Marathon 10K Run','Annual 10K run for all levels.','Timed race with medals and afterparty.',1756713600,'City Center, Oslo',400,3,'Sport','https://example.com/images/run.jpg',1763377533,NULL,NULL,'upcoming');
INSERT INTO "events" VALUES(7,'Cultural Night Market','Stands, performances and food from around the world.','Evening market celebrating diversity.',1752343200,'Old Town Square, Fredrikstad',100,4,'Culture','https://example.com/images/culture-night.jpg',1763377533,NULL,NULL,'upcoming');
INSERT INTO "events" VALUES(8,'Frontend Workshop','Hands-on React and TypeScript workshop.','Bring your laptop and build a small app.',1742896800,'Cowork Space, Oslo',900,2,'Technology','https://example.com/images/frontend-workshop.jpg',1763377533,NULL,NULL,'upcoming');
