...
export function Footer() {
  return (
    <footer className="bg-white">
      <section className="mx-auto max-w-7xl px-6 pt-16 pb-8 sm:pt-24 lg:px-8 lg:pt-32">
        <section className="xl:grid xl:grid-cols-3 xl:gap-8">
          <address className="space-y-8">
            ...
            <nav aria-label="Social media" className="flex gap-x-6">
          ...
          <nav className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
        ...
        <section className="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 lg:mt-24">
