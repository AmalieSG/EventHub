    ...
    <nav className="bg-white font-sans">
      <Disclosure as="nav" className="relative bg-white">
          <section className="mx-auto max-w-7xl">
              <section className="flex h-16 justify-between items-center">
                  <section aria-label="Primary Navigation and Logo" className="flex items-center">
                      ...
                      <menu className="hidden lg:ml-6 lg:flex lg:space-x-8" role="list">
                          {menu.map((item) => {
                  ...
                  <figure className="flex flex-1 items-center justify-center px-2 lg:ml-6 lg:justify-end">
                  ...
                  <section aria-label="User Controls" className="flex items-center space-x-4">
                      ...
                      <figure className="hidden lg:flex lg:items-center">
          ...
          <DisclosurePanel className="lg:hidden">
              ...
              <menu className="space-y-1 pt-2 pb-3" role="list">
                  {menu.map((item) => {
                      const isActive = currentPath === item.href
                      return (
                          <li key={item.name}>
              ...
              <section aria-label="Mobile User Profile" className="border-t border-gray-200 pt-4 pb-3">
                  ...
                  {isAuthenticated ? (
                      <figure className="flex items-center px-4">
                  ...
                  <menu className="mt-3 space-y-1" role="list">
                      {isAuthenticated ? (
                          userNavigationItems.map((item) => (
                              <li key={item.name}>
                                  <DisclosureButton
