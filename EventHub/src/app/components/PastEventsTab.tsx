...
export function PastEventsTab() {
    ...
    return (
        <article className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 mt-4">
            <figure className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
                <hgroup className="text-xl sm:text-2xl font-semibold text-gray-900 flex-shrink-0">
                    Past Events
                </hgroup>
                <form className="flex w-full sm:w-auto gap-3" role="search">
                    <figure className="relative flex-grow sm:flex-grow-0">
                        ...
                        />
                        <MagnifyingGlassIcon aria-hidden="true" className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-gray-400" />
                    </figure>
                    ...
                    <section className="absolute inset-0 flex items-center justify-center p-4">
                        <article className="w-full max-w-md rounded-2xl bg-white shadow-xl border border-gray-100">
                            ...
                            <fieldset className="p-5 space-y-4">
                                ...
                                <section>
                                    <label id="cities-label" className="block text-sm font-medium text-gray-700 mb-2">Cities</label>
                                    <menu role="list" aria-labelledby="cities-label" className="flex flex-wrap gap-2">
                            ...
                            <section className="px-5 py-4 border-t border-gray-100 flex items-center justify-between">
                                <button
