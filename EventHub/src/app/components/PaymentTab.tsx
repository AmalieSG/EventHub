...
export function PaymentTab() {
    ...
    return (
        <article className="mx-auto max-w-7xl py-8 lg:flex lg:gap-x-16 lg:px-8">
            <section className="px-4 py-4 sm:px-6 lg:flex-auto lg:px-0">
                <section aria-labelledby="billing-heading" className="space-y-8">
                    
                    <hgroup>
                        <h1 id="billing-heading" className="text-2xl font-bold text-gray-900">Payment & Subscription</h1>
                    ...
                    <figure className="bg-white shadow-lg rounded-xl p-6 border border-gray-100">
                        ...
                        <menu className="mt-6 pt-4 border-t flex justify-start gap-4" role="list">
                            <li>
                                <button
                                    type="button"
