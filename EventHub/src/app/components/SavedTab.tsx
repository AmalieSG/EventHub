...
import { MagnifyingGlassIcon, FunnelIcon, CalendarIcon, MapPinIcon, HeartIcon } from '@heroicons/react/24/outline';
...
const savedEventsInitial = [
  { id: 301, title: 'Music Festival 2026', date: 'Mar 15, 2026 at 3:00 PM', location: 'San Francisco, CA', imageUrl: sharedImage },
  { id: 302, title: 'Tech Innovation Summit', date: 'Apr 5, 2026 at 10:00 AM', location: 'New York, NY', imageUrl: sharedImage },
  { id: 303, title: 'Art Gallery Opening', date: 'May 20, 2026 at 6:00 PM', location: 'Austin, TX', imageUrl: sharedImage },
  { id: 304, title: 'Virtual Coding Bootcamp', date: 'Jun 10, 2026 at 9:00 AM', location: 'Online Event', imageUrl: sharedImage },
];

const SavedEventCard: React.FC<{ 
  event: typeof savedEventsInitial[number];
    ...
    <div className="flex bg-white rounded-xl shadow-lg hover:shadow-xl transition duration-300 p-4 border border-gray-100">
      ...
      <div className="flex flex-col justify-center items-end ml-4 space-y-2">
        ...
        <button 
          ...
          className="w-28 text-center inline-flex items-center justify-center gap-1 px-4 py-2 text-xs sm:text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-full shadow-sm hover:bg-gray-100 transition duration-150 cursor-pointer"
        >
...
export function SavedTab() {
  ...
  const [savedEvents, setSavedEvents] = useState(savedEventsInitial);
  ...
  const filteredEvents = useMemo(() => {
    const base = savedEvents.filter((event) => {
        ...
        {filteredEvents.length > 0 ? (
          ...
          <div className="text-center p-10 bg-white rounded-xl shadow-md text-gray-500">
            {savedEvents.length === 0 
              ? 'No saved events yet. Start saving events to see them here!'
